module tests {
    ...
    assert("unfoldr",           "[9,8,7,6,5,4,3,2,1,]", showList(showNum)(   unfoldr ( (x: Natural) =>lif(isZero(x))(_=>nothing)(_=>just(tuple(x)(pred(x))))) (_9)    ));
    ...
    console.log(name( yuzuko ))    // "Yuzuko"
    console.log(age( yukari ))     // 16
}
